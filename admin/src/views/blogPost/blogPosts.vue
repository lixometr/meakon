<template>
  <div v-if="!$store.getters.isLoading">
    ...
    <BtnAdd @click="$router.push({ name: 'BlogPostNew' })"
      >Добавить пост</BtnAdd
    >
        ...
        <td>
          <div class="d-flex">
            <CButton
              color="warning"
              @click="
                $router.push({ name: 'BlogPost', params: { id: item._id } })
              "
            >
...
export default {
  ...
  data() {
    return {
      fetchRoute: "blogPostsSearch",
      removeRoute: "blogPostById",
      fields: [
        {
          key: "name",
          label: "Название",
