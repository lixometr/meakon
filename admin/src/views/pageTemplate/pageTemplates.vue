<template>
  <div v-if="!$store.getters.isLoading">
    ...
    <BtnAdd @click="$router.push({ name: 'PageTemplateNew' })"
      >Добавить шаблон</BtnAdd
    >
        ...
        <td>
          <div class="d-flex">
            <CButton
              color="warning"
              @click="
                $router.push({ name: 'PageTemplate', params: { id: item._id } })
              "
            >
...
export default {
  ...
  data() {
    return {
      fetchRoute: "pageTemplatesSearch",
      removeRoute: "pageTemplateById",
      fields: [
        {
          key: "name",
          label: "Название",
