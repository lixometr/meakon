<template>
  <div v-if="!$store.getters.isLoading">
    ...
    <BtnAdd @click="$router.push({ name: 'SectionNew' })"
      >Добавить раздел</BtnAdd
    >
        ...
        <td>
          <div class="d-flex">
            <CButton
              color="warning"
              @click="
                $router.push({ name: 'Section', params: { id: item._id } })
              "
            >
...
export default {
  ...
  data() {
    return {
      fetchRoute: "sectionsSearch",
      removeRoute: "sectionById",
      fields: [
        {
          key: "name",
          label: "Название",
